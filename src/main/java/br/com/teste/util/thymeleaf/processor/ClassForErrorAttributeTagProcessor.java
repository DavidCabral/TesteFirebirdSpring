package br.com.teste.util.thymeleaf.processor;
...
public class ClassForErrorAttributeTagProcessor extends AbstractAttributeTagProcessor {
	...
	protected void doProcess(ITemplateContext context, IProcessableElementTag tag, AttributeName attributeName,
		...
		if (temErro) {
			...
			structureHandler.setAttribute("class", classesExistentes + " invalid");
			
			String error = FieldUtils.errors(context, attributeValue).get(0);			
			structureHandler.setAttribute("data-error", error);
		}
